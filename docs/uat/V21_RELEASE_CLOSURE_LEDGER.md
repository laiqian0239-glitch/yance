...
- imported P0 rows: **31**
- `SOURCE_GATE_CLOSED_RC_PENDING`: **16**
- finally `CLOSED`: **0**
...
Current strict counters after the post-KF-P0-11 exact-main checkpoint:

```text
knownFindingsP0Total=31
knownFindingsP0SourceGateClosedRcPending=16
