...
test('real Model Brain V3 exact head is revoked by trusted-main V4 supersession', { timeout: 45000 }, () => {
  const {
  ...
  assert.ok(realDependencies, 'trusted Git identity preparation must resolve current main and exact remote Model Brain V3 ref');
