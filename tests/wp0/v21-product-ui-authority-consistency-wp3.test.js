...
test('WP3 preserve: authenticated security state projects through Yance Product primary composition', () => {
  ...
  assert.doesNotMatch(index, /registerGlobalRightPanel|openGlobalRightPanel/u);
});
