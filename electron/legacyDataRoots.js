...
function discoverLegacyDataRoots(options = {}) {
  if (!options.currentRoot) throw new TypeError('currentRoot is required');
...
module.exports = { LEGACY_MARKERS, discoverLegacyDataRoots, hasMigrationMarker, splitExplicitRoots, expectedYance27Root };
