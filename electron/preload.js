...
contextBridge.exposeInMainWorld('yanceDesktop', Object.freeze({
  ...
  getLearningWorkspaceSnapshot: () => ipcRenderer.invoke('desktop:learning-workspace-snapshot'),
  invokeLearningCoachAction: input => ipcRenderer.invoke('desktop:learning-coach-invoke', input || {}),
  ...
  getParlantDailyChatGoal: input => ipcRenderer.invoke('desktop:parlant-get-daily-chat-goal', input || {}),
  upsertParlantDailyChatGoal: input => ipcRenderer.invoke('desktop:parlant-upsert-daily-chat-goal', input || {}),
  deleteParlantDailyChatGoal: input => ipcRenderer.invoke('desktop:parlant-delete-daily-chat-goal', input || {}),
  ...
  listVoiceProfiles: () => ipcRenderer.invoke('desktop:voice-brain-list-profiles'),
  ...
  storeSearchWorkspace: input => invokeStore('store:search-workspace', input),
  ensureMatrixDirectConversationProjection: input => invokeStore('store:matrix-direct-projection', input || {}),
  storeTranslateChinese: input => invokeStore('store:translate-chinese', input || {}),
  storeCreateTranslationJob: input => invokeStore('store:create-translation-job', input),
  storeGetTranslationJob: input => invokeStore('store:get-translation-job', input),
  storeCancelTranslationJob: input => invokeStore('store:cancel-translation-job', input),
  ...
  listPersonaScopes: input => invokeStore('store:persona-scopes', input || {}),
  getPersonaCurrent: input => invokeStore('store:persona-current', input || {}),
  setPersonaScope: input => invokeStore('store:persona-set-scope', input || {}),
  clearPersonaScope: input => invokeStore('store:persona-clear-scope', input || {}),
  listPersonaVersions: input => invokeStore('store:persona-versions', input || {}),
  importPersona: input => invokeStore('store:persona-import', input || {}),
  initializeDefaultPersona: input => invokeStore('store:persona-initialize-default', input || {}),
  updatePersonaAuthoritative: input => invokeStore('store:persona-update-authoritative', input || {}),
  diffPersonaVersions: input => invokeStore('store:persona-version-diff', input || {}),
  rollbackPersona: input => invokeStore('store:persona-rollback', input || {}),
  setConversationArchived: input => invokeStore('store:workspace-conversation-archive', input || {}),
  setConversationPinned: input => invokeStore('store:workspace-conversation-pin', input || {}),
  mergeContacts: input => invokeStore('store:workspace-contact-merge', input || {}),
  undoContactMerge: input => invokeStore('store:workspace-contact-merge-undo', input || {}),
  reviewContactProfile: input => invokeStore('store:workspace-profile-review', input || {}),
  markRelationshipKeyNode: input => invokeStore('store:workspace-key-node-mark', input || {}),
  unmarkRelationshipKeyNode: input => invokeStore('store:workspace-key-node-unmark', input || {}),
  getNotificationSettings: () => invokeStore('store:notification-settings'),
  updateNotificationSettings: input => invokeStore('store:notification-settings-update', input || {}),
  createNotificationSound: input => invokeStore('store:notification-sound-create', input || {}),
  deleteNotificationSound: input => invokeStore('store:notification-sound-delete', input || {}),
  ...
  loginPersonalAccess: input => invokeStore('store:personal-access-login', input || {}),
  activatePersonalAccess: input => invokeStore('store:personal-access-activate', input || {}),
  logoutPersonalAccess: () => invokeStore('store:personal-access-logout'),
  setConversationAutomationMode: input => invokeStore('store:conversation-automation-mode', input || {}),
  prepareOutboundMessage: input => invokeStore('store:outbound-prepare', input || {}),
  prepareHumanTypingElementSend: input => invokeStore('store:human-typing-prepare', input || {}),
  releaseHumanTypingElementSend: input => invokeStore('store:human-typing-release', input || {}),
  cancelHumanTypingElementSend: input => invokeStore('store:human-typing-cancel', input || {}),
  completeHumanTypingElementSend: input => invokeStore('store:human-typing-complete', input || {}),
  createPlatformAccount: input => invokeStore('store:platform-account-create', input || {}),
  runPlatformAccountCommand: input => invokeStore('store:platform-account-command', input || {}),
  listPlatformAccounts: input => invokeStore('store:platform-accounts-list', input || {}),
  getPlatformAccountCapabilities: () => invokeStore('store:platform-account-capabilities'),
  getPlatformAccountAudit: input => invokeStore('store:platform-account-audit', input || {}),
  connectPlatformAccount: input => invokeStore('store:platform-account-connect', input || {}),
  reconnectPlatformAccount: input => invokeStore('store:platform-account-reconnect', input || {}),
  syncPlatformAccount: input => invokeStore('store:platform-account-sync', input || {}),
  syncAllPlatformAccounts: input => invokeStore('store:platform-accounts-sync-all', input || {}),
  loadAiWorkspace: () => invokeStore('store:ai-workspace-load'),
  createAiWorkspaceTask: input => invokeStore('store:ai-workspace-create-task', input || {}),
  updateAiWorkspaceTask: input => invokeStore('store:ai-workspace-update-task', input || {}),
  runAiWorkspaceTask: input => invokeStore('store:ai-workspace-run-task', input || {}),
  previewPersonaCharacterCard: input => invokeStore('store:persona-character-card-preview', input || {}),
