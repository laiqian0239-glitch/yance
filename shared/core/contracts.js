...
const COMMANDS = Object.freeze({
  ...
  ACCOUNT_PROVISIONING_LOGIN_FLOWS: 'account.provisioning.login.flows',
  ACCOUNT_PROVISIONING_LOGIN_START: 'account.provisioning.login.start',
  ACCOUNT_PROVISIONING_LOGIN_INPUT: 'account.provisioning.login.input',
  ACCOUNT_PROVISIONING_LOGIN_WAIT: 'account.provisioning.login.wait',
  ACCOUNT_PROVISIONING_LOGIN_CANCEL: 'account.provisioning.login.cancel',
  ACCOUNT_PROVISIONING_DIRECT_CHAT_ENSURE: 'account.provisioning.directChat.ensure',
  ACCOUNT_FACEBOOK_PAGE_INBOXES: 'account.facebook.page.inboxes',
  ACCOUNT_FACEBOOK_PAGE_ATTACH: 'account.facebook.page.attach',
